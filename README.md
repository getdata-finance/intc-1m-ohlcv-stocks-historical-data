...
> **Sample on GitHub** · `INTC_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 5.60 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/intc)** — **635,826** `1m` rows, **11 timeframes**, `2020-02-24` -> `2026-09-01`.
...
df = pd.read_csv('INTC_1m.csv', parse_dates=['time'])
...
The complete **INTC** archive on **[getdata.finance](https://getdata.finance/datasets/intc)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **635,826** rows at `1m`, plus all other timeframes in the same ZIP.
