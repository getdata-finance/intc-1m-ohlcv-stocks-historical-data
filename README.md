...
> **Sample on GitHub** · `INTC_1m.csv` (55,440 rows, `2026-02-06` -> `2026-09-01`, 5.60 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/intc)** — **635,826** `1m` rows (full `1m`: 635,826), **11 timeframes**, `2020-02-24` -> `2026-09-01`.
